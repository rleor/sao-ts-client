 ...
 */ export var Api = /*#__PURE__*/ function(HttpClient) {
   ...
   */ _this.serviceSimulate = function(body) {
   ...
   */ _this.serviceGetTxsEvent = function(query) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
   ...
   */ _this.serviceBroadcastTx = function(body) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/tx/v1beta1/txs",
                method: "POST",
   ...
   */ _this.serviceGetBlockWithTxs = function(height, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/tx/v1beta1/txs/block/".concat(height),
                method: "GET",
                query: query,
                format: "json"
            }, params));
   ...
   */ _this.serviceGetTx = function(hash) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/tx/v1beta1/txs/".concat(hash),
                method: "GET",
                format: "json"
            }, params));
        };
