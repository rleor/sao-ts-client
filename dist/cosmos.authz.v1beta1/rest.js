 ...
 */ export var Api = /*#__PURE__*/ function(HttpClient) {
   ...
   */ _this.queryGrants = function(query) {
   ...
   */ _this.queryGranteeGrants = function(grantee, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/authz/v1beta1/grants/grantee/".concat(grantee),
                method: "GET",
                query: query,
                format: "json"
            }, params));
   ...
   */ _this.queryGranterGrants = function(granter, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/authz/v1beta1/grants/granter/".concat(granter),
                method: "GET",
                query: query,
                format: "json"
            }, params));
