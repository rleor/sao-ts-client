...
export var txClient = function() {
    ...
    return {
        sendMsgMultiSend: function sendMsgMultiSend(param) {
        ...
        sendMsgSend: function sendMsgSend(param) {
            var value = param.value, fee = param.fee, memo = param.memo;
            return _asyncToGenerator(function() {
                var address, signingClient, msg, e;
                return __generator(this, function(_state) {
        ...
        msgMultiSend: function msgMultiSend(param) {
        ...
        msgSend: function msgSend(param) {
            var value = param.value;
            try {
                return {
