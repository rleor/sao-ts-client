 ...
 */ export var Api = /*#__PURE__*/ function(HttpClient) {
   ...
   */ _this.queryAllBalances = function(address, query) {
   ...
   */ _this.queryBalance = function(address, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/bank/v1beta1/balances/".concat(address, "/by_denom"),
                method: "GET",
                query: query,
                format: "json"
            }, params));
 ...
 */ _this.queryDenomOwners = function(denom, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/bank/v1beta1/denom_owners/".concat(denom),
                method: "GET",
                query: query,
                format: "json"
            }, params));
 ...
 */ _this.queryDenomsMetadata = function(query) {
   ...
   */ _this.queryDenomMetadata = function(denom) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/bank/v1beta1/denoms_metadata/".concat(denom),
                method: "GET",
                format: "json"
            }, params));
        };
 ...
 */ _this.querySpendableBalances = function(address, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/bank/v1beta1/spendable_balances/".concat(address),
                method: "GET",
                query: query,
                format: "json"
            }, params));
   ...
   */ _this.queryTotalSupply = function(query) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
   ...
   */ _this.querySupplyOf = function(query) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
