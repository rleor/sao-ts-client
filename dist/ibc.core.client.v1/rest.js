 ...
 */ export var Api = /*#__PURE__*/ function(HttpClient) {
   ...
   */ _this.queryClientParams = function() {
   ...
   */ _this.queryClientStates = function(query) {
   ...
   */ _this.queryClientState = function(clientId) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/ibc/core/client/v1/client_states/".concat(clientId),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryClientStatus = function(clientId) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/ibc/core/client/v1/client_status/".concat(clientId),
                method: "GET",
                format: "json"
            }, params));
        };
 ...
 */ _this.queryConsensusStates = function(clientId, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/ibc/core/client/v1/consensus_states/".concat(clientId),
                method: "GET",
                query: query,
                format: "json"
            }, params));
   ...
   */ _this.queryConsensusStateHeights = function(clientId, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/ibc/core/client/v1/consensus_states/".concat(clientId, "/heights"),
                method: "GET",
                query: query,
                format: "json"
            }, params));
 ...
 */ _this.queryConsensusState = function(clientId, revisionNumber, revisionHeight, query) {
            var params = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : {};
            return _this.request(_objectSpread({
                path: "/ibc/core/client/v1/consensus_states/".concat(clientId, "/revision/").concat(revisionNumber, "/height/").concat(revisionHeight),
                method: "GET",
                query: query,
                format: "json"
            }, params));
   ...
   */ _this.queryUpgradedClientState = function() {
            var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            return _this.request(_objectSpread({
   ...
   */ _this.queryUpgradedConsensusState = function() {
            var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            return _this.request(_objectSpread({
