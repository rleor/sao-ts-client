 ...
 */ export var Api = /*#__PURE__*/ function(HttpClient) {
   ...
   */ _this.queryNodeAll = function(query) {
   ...
   */ _this.queryNode = function(creator) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/SaoNetwork/sao/node/node/".concat(creator),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryPledgeAll = function(query) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
   ...
   */ _this.queryPledge = function(creator) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/SaoNetwork/sao/node/pledge/".concat(creator),
                method: "GET",
                format: "json"
            }, params));
        };
