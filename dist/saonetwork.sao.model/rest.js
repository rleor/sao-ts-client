 ...
 */ export var Api = /*#__PURE__*/ function(HttpClient) {
   ...
   */ _this.queryMetadataAll = function(query) {
   ...
   */ _this.queryMetadata = function(dataId) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/SaoNetwork/sao/model/metadata/".concat(dataId),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryModelAll = function(query) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
   ...
   */ _this.queryModel = function(key) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/SaoNetwork/sao/model/model/".concat(key),
                method: "GET",
                format: "json"
            }, params));
        };
