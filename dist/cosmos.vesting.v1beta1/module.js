...
export var txClient = function() {
    ...
    return {
        sendMsgCreatePermanentLockedAccount: function sendMsgCreatePermanentLockedAccount(param) {
                ...
                return __generator(this, function(_state) {
                    switch(_state.label){
                        ...
                        case 3:
                            ...
                            msg = this.msgCreatePermanentLockedAccount({
        ...
        sendMsgCreateVestingAccount: function sendMsgCreateVestingAccount(param) {
            var value = param.value, fee = param.fee, memo = param.memo;
            return _asyncToGenerator(function() {
                var address, signingClient, msg, e;
                return __generator(this, function(_state) {
                    switch(_state.label){
                        ...
                        case 3:
                            signingClient = _state.sent();
                            msg = this.msgCreateVestingAccount({
        ...
        sendMsgCreatePeriodicVestingAccount: function sendMsgCreatePeriodicVestingAccount(param) {
            var value = param.value, fee = param.fee, memo = param.memo;
            return _asyncToGenerator(function() {
                var address, signingClient, msg, e;
                return __generator(this, function(_state) {
                    switch(_state.label){
                        ...
                        case 3:
                            signingClient = _state.sent();
                            msg = this.msgCreatePeriodicVestingAccount({
        ...
        msgCreatePermanentLockedAccount: function msgCreatePermanentLockedAccount(param) {
        ...
        msgCreateVestingAccount: function msgCreateVestingAccount(param) {
            var value = param.value;
            try {
                return {
        ...
        msgCreatePeriodicVestingAccount: function msgCreatePeriodicVestingAccount(param) {
            var value = param.value;
            try {
                return {
