 ...
 */ _this.queryClientConnections = function(clientId) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/ibc/core/connection/v1/client_connections/".concat(clientId),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryConnections = function(query) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
   ...
   */ _this.queryConnection = function(connectionId) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/ibc/core/connection/v1/connections/".concat(connectionId),
                method: "GET",
                format: "json"
            }, params));
        };
 ...
 */ _this.queryConnectionClientState = function(connectionId) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/ibc/core/connection/v1/connections/".concat(connectionId, "/client_state"),
                method: "GET",
                format: "json"
            }, params));
        };
 ...
 */ _this.queryConnectionConsensusState = function(connectionId, revisionNumber, revisionHeight) {
            var params = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {};
            return _this.request(_objectSpread({
                path: "/ibc/core/connection/v1/connections/".concat(connectionId, "/consensus_state/revision/").concat(revisionNumber, "/height/").concat(revisionHeight),
                method: "GET",
                format: "json"
            }, params));
        };
