 ...
 */ export var Api = /*#__PURE__*/ function(HttpClient) {
   ...
   */ _this.queryAppliedPlan = function(name) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/upgrade/v1beta1/applied_plan/".concat(name),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryCurrentPlan = function() {
            var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            return _this.request(_objectSpread({
   ...
   */ _this.queryModuleVersions = function(query) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
 ...
 */ _this.queryUpgradedConsensusState = function(lastHeight) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/upgrade/v1beta1/upgraded_consensus_state/".concat(lastHeight),
                method: "GET",
                format: "json"
            }, params));
        };
