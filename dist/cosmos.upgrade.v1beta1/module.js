...
export var txClient = function() {
    ...
    return {
        sendMsgCancelUpgrade: function sendMsgCancelUpgrade(param) {
        ...
        sendMsgSoftwareUpgrade: function sendMsgSoftwareUpgrade(param) {
            var value = param.value, fee = param.fee, memo = param.memo;
            return _asyncToGenerator(function() {
                var address, signingClient, msg, e;
                return __generator(this, function(_state) {
        ...
        msgCancelUpgrade: function msgCancelUpgrade(param) {
        ...
        msgSoftwareUpgrade: function msgSoftwareUpgrade(param) {
            var value = param.value;
            try {
                return {
