...
export var txClient = function() {
    ...
    return {
        sendMsgSetWithdrawAddress: function sendMsgSetWithdrawAddress(param) {
                ...
                return __generator(this, function(_state) {
                    switch(_state.label){
                        ...
                        case 3:
                            ...
                            msg = this.msgSetWithdrawAddress({
        ...
        sendMsgWithdrawDelegatorReward: function sendMsgWithdrawDelegatorReward(param) {
            var value = param.value, fee = param.fee, memo = param.memo;
            return _asyncToGenerator(function() {
                var address, signingClient, msg, e;
                return __generator(this, function(_state) {
                    switch(_state.label){
                        ...
                        case 3:
                            signingClient = _state.sent();
                            msg = this.msgWithdrawDelegatorReward({
        ...
        sendMsgWithdrawValidatorCommission: function sendMsgWithdrawValidatorCommission(param) {
            var value = param.value, fee = param.fee, memo = param.memo;
            return _asyncToGenerator(function() {
                var address, signingClient, msg, e;
                return __generator(this, function(_state) {
                    switch(_state.label){
                        ...
                        case 3:
                            signingClient = _state.sent();
                            msg = this.msgWithdrawValidatorCommission({
        ...
        sendMsgFundCommunityPool: function sendMsgFundCommunityPool(param) {
            var value = param.value, fee = param.fee, memo = param.memo;
            return _asyncToGenerator(function() {
                var address, signingClient, msg, e;
                return __generator(this, function(_state) {
        ...
        msgSetWithdrawAddress: function msgSetWithdrawAddress(param) {
        ...
        msgWithdrawDelegatorReward: function msgWithdrawDelegatorReward(param) {
            var value = param.value;
            try {
                return {
        ...
        msgWithdrawValidatorCommission: function msgWithdrawValidatorCommission(param) {
            var value = param.value;
            try {
                return {
        ...
        msgFundCommunityPool: function msgFundCommunityPool(param) {
            var value = param.value;
            try {
                return {
