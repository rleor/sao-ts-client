 ...
 */ export var Api = /*#__PURE__*/ function(HttpClient) {
   ...
   */ _this.queryCommunityPool = function() {
 ...
 */ _this.queryDelegationTotalRewards = function(delegatorAddress) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/distribution/v1beta1/delegators/".concat(delegatorAddress, "/rewards"),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryDelegationRewards = function(delegatorAddress, validatorAddress) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/distribution/v1beta1/delegators/".concat(delegatorAddress, "/rewards/").concat(validatorAddress),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryDelegatorValidators = function(delegatorAddress) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/distribution/v1beta1/delegators/".concat(delegatorAddress, "/validators"),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryDelegatorWithdrawAddress = function(delegatorAddress) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/distribution/v1beta1/delegators/".concat(delegatorAddress, "/withdraw_address"),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryValidatorCommission = function(validatorAddress) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/distribution/v1beta1/validators/".concat(validatorAddress, "/commission"),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryValidatorOutstandingRewards = function(validatorAddress) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/distribution/v1beta1/validators/".concat(validatorAddress, "/outstanding_rewards"),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryValidatorSlashes = function(validatorAddress, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/distribution/v1beta1/validators/".concat(validatorAddress, "/slashes"),
                method: "GET",
                query: query,
                format: "json"
            }, params));
