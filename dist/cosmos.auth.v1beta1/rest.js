 ...
 */ export var Api = /*#__PURE__*/ function(HttpClient) {
   ...
   */ _this.queryAccounts = function(query) {
   ...
   */ _this.queryAccount = function(address) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/auth/v1beta1/accounts/".concat(address),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryAccountAddressById = function(id) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/auth/v1beta1/address_by_id/".concat(id),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryBech32Prefix = function() {
   ...
   */ _this.queryAddressBytesToString = function(addressBytes) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/auth/v1beta1/bech32/".concat(addressBytes),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryAddressStringToBytes = function(addressString) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/auth/v1beta1/bech32/".concat(addressString),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryModuleAccounts = function() {
            var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            return _this.request(_objectSpread({
