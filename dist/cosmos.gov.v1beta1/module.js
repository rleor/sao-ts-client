...
export var txClient = function() {
    ...
    return {
        sendMsgDeposit: function sendMsgDeposit(param) {
        ...
        sendMsgVoteWeighted: function sendMsgVoteWeighted(param) {
            var value = param.value, fee = param.fee, memo = param.memo;
            return _asyncToGenerator(function() {
                var address, signingClient, msg, e;
                return __generator(this, function(_state) {
        ...
        msgDeposit: function msgDeposit(param) {
        ...
        msgVoteWeighted: function msgVoteWeighted(param) {
            var value = param.value;
            try {
                return {
