 ...
 */ export var Api = /*#__PURE__*/ function(HttpClient) {
   ...
   */ _this.queryAccountAuthAll = function(query) {
   ...
   */ _this.queryAccountAuth = function(accountDid) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/SaoNetwork/sao/did/account_auth/".concat(accountDid),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryAccountListAll = function(query) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
   ...
   */ _this.queryAccountList = function(did) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/SaoNetwork/sao/did/account_list/".concat(did),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryDidBindingProofsAll = function(query) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
   ...
   */ _this.queryDidBindingProofs = function(accountId) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/SaoNetwork/sao/did/did_binding_proofs/".concat(accountId),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryGetAllAccountAuths = function(did) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/SaoNetwork/sao/did/get_all_account_auths/".concat(did),
                method: "GET",
                format: "json"
            }, params));
        };
