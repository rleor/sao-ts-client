 ...
 */ export var Api = /*#__PURE__*/ function(HttpClient) {
   ...
   */ _this.queryDelegatorDelegations = function(delegatorAddr, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/staking/v1beta1/delegations/".concat(delegatorAddr),
                method: "GET",
                query: query,
                format: "json"
            }, params));
   ...
   */ _this.queryRedelegations = function(delegatorAddr, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/staking/v1beta1/delegators/".concat(delegatorAddr, "/redelegations"),
                method: "GET",
                query: query,
                format: "json"
            }, params));
 ...
 */ _this.queryDelegatorUnbondingDelegations = function(delegatorAddr, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/staking/v1beta1/delegators/".concat(delegatorAddr, "/unbonding_delegations"),
                method: "GET",
                query: query,
                format: "json"
            }, params));
 ...
 */ _this.queryDelegatorValidators = function(delegatorAddr, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/staking/v1beta1/delegators/".concat(delegatorAddr, "/validators"),
                method: "GET",
                query: query,
                format: "json"
            }, params));
 ...
 */ _this.queryDelegatorValidator = function(delegatorAddr, validatorAddr) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/staking/v1beta1/delegators/".concat(delegatorAddr, "/validators/").concat(validatorAddr),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryHistoricalInfo = function(height) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/staking/v1beta1/historical_info/".concat(height),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryValidators = function(query) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
   ...
   */ _this.queryValidator = function(validatorAddr) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/staking/v1beta1/validators/".concat(validatorAddr),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryValidatorDelegations = function(validatorAddr, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/staking/v1beta1/validators/".concat(validatorAddr, "/delegations"),
                method: "GET",
                query: query,
                format: "json"
            }, params));
   ...
   */ _this.queryDelegation = function(validatorAddr, delegatorAddr) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/staking/v1beta1/validators/".concat(validatorAddr, "/delegations/").concat(delegatorAddr),
                method: "GET",
                format: "json"
            }, params));
        };
 ...
 */ _this.queryUnbondingDelegation = function(validatorAddr, delegatorAddr) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/staking/v1beta1/validators/".concat(validatorAddr, "/delegations/").concat(delegatorAddr, "/unbonding_delegation"),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryValidatorUnbondingDelegations = function(validatorAddr, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/staking/v1beta1/validators/".concat(validatorAddr, "/unbonding_delegations"),
                method: "GET",
                query: query,
                format: "json"
            }, params));
