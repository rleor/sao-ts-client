...
export var txClient = function() {
    ...
    return {
        sendMsgGrantAllowance: function sendMsgGrantAllowance(param) {
        ...
        sendMsgRevokeAllowance: function sendMsgRevokeAllowance(param) {
            var value = param.value, fee = param.fee, memo = param.memo;
            return _asyncToGenerator(function() {
                var address, signingClient, msg, e;
                return __generator(this, function(_state) {
        ...
        msgGrantAllowance: function msgGrantAllowance(param) {
        ...
        msgRevokeAllowance: function msgRevokeAllowance(param) {
            var value = param.value;
            try {
                return {
