 ...
 */ export var Api = /*#__PURE__*/ function(HttpClient) {
   ...
   */ _this.queryBalance = function(owner, classId) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/nft/v1beta1/balance/".concat(owner, "/").concat(classId),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryClasses = function(query) {
   ...
   */ _this.queryClass = function(classId) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/nft/v1beta1/classes/".concat(classId),
                method: "GET",
                format: "json"
            }, params));
        };
 ...
 */ _this.queryNfTs = function(query) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
   ...
   */ _this.queryNft = function(classId, id) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/nft/v1beta1/nfts/".concat(classId, "/").concat(id),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryOwner = function(classId, id) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/nft/v1beta1/owner/".concat(classId, "/").concat(id),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.querySupply = function(classId) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/nft/v1beta1/supply/".concat(classId),
                method: "GET",
                format: "json"
            }, params));
        };
