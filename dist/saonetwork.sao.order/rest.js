 ...
 */ export var Api = /*#__PURE__*/ function(HttpClient) {
   ...
   */ _this.queryOrderAll = function(query) {
   ...
   */ _this.queryOrder = function(id) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/SaoNetwork/sao/order/order/".concat(id),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryShardAll = function(query) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
   ...
   */ _this.queryShard = function(id) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/SaoNetwork/sao/order/shard/".concat(id),
                method: "GET",
                format: "json"
            }, params));
        };
