 ...
 */ export var Api = /*#__PURE__*/ function(HttpClient) {
   ...
   */ _this.queryParams = function(paramsType) {
            ...
            return _this.request(_objectSpread({
                path: "/cosmos/gov/v1/params/".concat(paramsType),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryProposal = function(proposalId) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/gov/v1/proposals/".concat(proposalId),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryDeposits = function(proposalId, query) {
            ...
            return _this.request(_objectSpread({
                path: "/cosmos/gov/v1/proposals/".concat(proposalId, "/deposits"),
                method: "GET",
                query: query,
                format: "json"
            }, params));
   ...
   */ _this.queryDeposit = function(proposalId, depositor) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/gov/v1/proposals/".concat(proposalId, "/deposits/").concat(depositor),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryTallyResult = function(proposalId) {
            var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/gov/v1/proposals/".concat(proposalId, "/tally"),
                method: "GET",
                format: "json"
            }, params));
        };
   ...
   */ _this.queryVotes = function(proposalId, query) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/gov/v1/proposals/".concat(proposalId, "/votes"),
                method: "GET",
                query: query,
                format: "json"
            }, params));
   ...
   */ _this.queryVote = function(proposalId, voter) {
            var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
            return _this.request(_objectSpread({
                path: "/cosmos/gov/v1/proposals/".concat(proposalId, "/votes/").concat(voter),
                method: "GET",
                format: "json"
            }, params));
        };
